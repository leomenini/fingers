...
\begin{tikzpicture}
  % carga Q1 (origen)
  \node[figneg] at (0,0) {};
  \node[figlbl, above left=1pt] at (0,0) {$Q_1$};
  % F12 desde Q1
  \draw[figvec] (0,0) -- (1.59,0)
        node[figlbl, midway, above]{$\vec F_{12}$};
  % F13 desde la punta de F12 (traslación)
  \draw[figvec] (1.59,0) -- (2.77,-1.89)
        node[figlbl, pos=0.55, right=1pt]{$\vec F_{13}$};
  % resultante F1 desde Q1
  \draw[figvecres] (0,0) -- (2.77,-1.89)
        node[figlbl, pos=0.55, below left=1pt]{$\vec F_{1}$};
