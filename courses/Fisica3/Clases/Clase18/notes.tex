...
\input{assets/clase18-toroide.tex}
...
\input{assets/clase18-faraday-iman.tex}
...
\input{assets/clase18-faraday-electroiman.tex}
...
\input{assets/clase18-flujo.tex}
...
\input{assets/clase18-rampa.tex}
...
Campo uniforme entrante $B$; espira rectangular (lado vertical $D$ ---el que
queda dentro del campo---, horizontal $L$) con porción $x$ dentro, moviéndose hacia afuera con velocidad $v$;
...
\input{assets/clase18-espira-sale.tex}
...
\input{assets/clase18-frenos.tex}
