...
\input{assets/clase19-varilla.tex}
...
\input{assets/clase19-generador.tex}
...
\input{assets/clase19-motor-generador.tex}
...
\input{assets/clase19-cable-fino.tex}
...
\input{assets/clase19-campo-inducido.tex}
...
\input{assets/clase19-autoinduccion.tex}
...
\input{assets/clase19-signos-bobina.tex}

\subsection{Ejemplo: el toroide}

Toroide de sección rectangular (altura $h$, radios $A$ y $B$, con $N$
espiras), donde $B(r) = \mu_0 N I/(2\pi r)$. Flujo en una espira:
\[
...
\input{assets/clase19-toroide-L.tex}
